                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="form-group col-12">
                                <label>Ukuran</label>
                                <input type="text" class="form-control" name="Ukuran_Tampil"
                                    value="{{ $Produk->Ukuran_Produk }}" disabled>
                                <input type="text" class="form-control" name="Ukuran_Produk"
                                    value="{{ $Produk->Ukuran_Produk }}" hidden>
                            </div>
                            ...
                            <div class="form-group col-12">
                                <label>Jumlah</label>
                                <input type="text" class="form-control @error('Jumlah_BOM') is-invalid @enderror"
                                    name="Jumlah_BOM" required>
                                @error('Jumlah_BOM')
                                ...
                                <tbody>
                                    @foreach ($BOM as $BOM)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/BOM/deleteBOM/{{ $BOM->ID_BOM }}"
