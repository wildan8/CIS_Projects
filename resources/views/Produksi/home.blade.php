...
<section class="section">
    ...
    <div class="section-body">
        <form action="/Produksi" method="get">
            ...
            <div class="table-responsive p-2">
                <table class=" table table-striped table-md">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if (strlen($item->Kode_MPS) > 10)
                                {{ substr($item->Kode_MPS, 0, 10) . '...' }}
                                @else
                                {{ $item->Kode_MPS }}
                                @endif
                            </td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#exportpdf').attr('href', '/Produksi/exportAll/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))
        ...
        $('#created_at').daterangepicker({
            ...
            $('#exportpdf').attr('href', '/Produksi/exportAll/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
        })
    })
